    ...
    <>
      <header className="d-flex flex-wrap justify-content-between align-items-center py-3  nav-bar">
        ...
        <ul className="nav nav-pills" ref={menuRef}>
          ...
          <li className="nav-item">
            <AnchorLink offset={50} href="#Aboutme" className="anchor-link">
              About me
            </AnchorLink>
          </li>
          <li className="nav-item">
            <AnchorLink offset={50} href="#Coding" className="anchor-link">
              Coding
            </AnchorLink>
          </li>
          <li className="nav-item">
            <AnchorLink offset={50} href="#Projects" className="anchor-link">
              Projects
            </AnchorLink>
          </li>
          <li className="nav-item">
